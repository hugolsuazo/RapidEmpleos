...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2021 a las 03:15:08
...
--
-- Filtros para la tabla `publicar_empleo`
--
ALTER TABLE `publicar_empleo`
  ADD CONSTRAINT `publicar_empleo_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
